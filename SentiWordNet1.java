...
public class SentiWordNet1 
{
	private Map<String, Double> dictionary;

	public SentiWordNet1(String pathToSWN) throws IOException 
	{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		long supplierId = Long.parseLong((text.substring(0, index)));
		text.replace(supplierId + " ", "");
		...
		PrintWriter factpw = new PrintWriter(new FileWriter("factualSuppliers.txt", true),true);
		PrintWriter fraudpw = new PrintWriter(new FileWriter("fraudulentSuppliers.txt", true),true);
	    /*System.out.println("Score:"+totalScore);
        if(totalScore >= 0.75)
            JOptionPane.showMessageDialog(null, "very positive");
            ...
            JOptionPane.showMessageDialog(null, "very negative");
        else
        	JOptionPane.showMessageDialog(null, "neutral");
        */
        if(totalScore > 0)
        	factpw.println( supplierId + "\t" + totalScore);
        else if(totalScore < 0)
        	fraudpw.println(supplierId + "\t" + totalScore);
        factpw.close();
        fraudpw.close();
    }
}